                    ...
                    <div class="circle_chart pt-5">
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="canvas-body" style="height: 630px;">
                                    <h4>Courier Split</h4>
                                    <div class="canvas">
                                        <canvas class="mb-5 mx-auto" id="myChart" height="300" width="300" aria-label="chart" role="img"></canvas>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="canvas-body" style="height: 630px;">
                                    ...
                                    <div class="canvas">
                                        <canvas class=" mx-auto" id="myChart2" height="300" width="300" aria-label="chart" role="img"></canvas>
                                            <?php $i=0; ?>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="canvas-body" style="height: 630px;">
                                    ...
                                    <div class="canvas">
                                        <canvas class="mb-5 mx-auto" id="myChart4" height="300" width="300" aria-label="chart" role="img"></canvas>
                                        <div class="canvas-text">
                                            <div class="canvas-circle canvas-pink"></div>
                                            <div>Total  products</div>
                                        </div>
